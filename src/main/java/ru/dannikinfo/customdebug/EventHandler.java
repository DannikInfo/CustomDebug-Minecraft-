...
public class EventHandler{
   ...
   public void drawDebug(RenderGameOverlayEvent e){
       ...
       fontrenderer.drawStringWithShadow(StatCollector.translateToLocal("customdebug.biome") + ": " + chunk.getBiome(blockpos, this.mc.theWorld.getWorldChunkManager()).biomeName, 2, 42, 16777215);
       fontrenderer.drawStringWithShadow(StatCollector.translateToLocal("customdebug.light") + ": " + chunk.getLightFor(EnumSkyBlock.BLOCK, blockpos), 2, 52, 16777215);
