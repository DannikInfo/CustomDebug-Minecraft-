...
public class EventHandler{
   ...
   public void drawDebug(RenderGameOverlayEvent e){
       ...
       String usemem = I18n.translateToLocal("customdebug.usemem") + ": " + l5 * 100L / i5 + "% - " + l5 / 1024L / 1024L + "MB / " + i5 / 1024L / 1024L + "MB";
       String alocmem = I18n.translateToLocal("customdebug.allocmem") + ": " + j5 * 100L / i5 + "% - " + j5 / 1024L / 1024L + "MB / " + i5 / 1024L / 1024L + "MB";
       ...
       fontrenderer.drawStringWithShadow(I18n.translateToLocal("customdebug.biome") + ": " + chunk.getBiome(blockpos, this.mc.theWorld.getBiomeProvider()).getBiomeName(), 2, 42, 16777215);
       fontrenderer.drawStringWithShadow(I18n.translateToLocal("customdebug.light") + ": " + chunk.getLightFor(EnumSkyBlock.BLOCK, blockpos), 2, 52, 16777215);
