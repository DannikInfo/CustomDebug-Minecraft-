...
public class RendererPowerPortal extends TileEntitySpecialRenderer {

	public static final PortalModel model = new PortalModel();
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityPowerPortal)tile, x, y, z, f);
	}
